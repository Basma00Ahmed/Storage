...
namespace Storage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        public async Task<IActionResult> Index(string name, string drpCategories)
        {
            var categoryList = _context.Product
            ...
            var model = _context.Product
                                   .Where(e => (string.IsNullOrWhiteSpace(name) || e.Name.StartsWith(name)) &&
                                         (string.IsNullOrWhiteSpace(drpCategories) || e.Category == drpCategories))
